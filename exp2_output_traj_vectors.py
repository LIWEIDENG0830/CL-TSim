...
test_model_dir = "./log/1629475290.7133796/"        # chengdu
test_model_type = "LSTM"
save_output_format = "./outputs_exp2/{}_r{}_{}_{}_hiddensize_{}_batchsize_{}_bidirectional_{}_nlayers_{}_freeze_{}_chengdu.pkl"

for aug_type in ["distorting", "downsampling"]:
    for ratio in [2, 3, 4, 5, 6]:
        #test_data_path = "../t2vec-master/experiment/exp2/{}-r{}-trj.t".format(aug_type, ratio)
        test_data_path = "../didi_200/experiment/exp2/{}-r{}-trj.t".format(aug_type, ratio)
